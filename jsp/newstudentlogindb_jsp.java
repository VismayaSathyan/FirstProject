...
public final class newstudentlogindb_jsp extends org.apache.jasper.runtime.HttpJspBase
...
PreparedStatement st= con.prepareStatement(inquery);
    st.executeUpdate();*/
    String querya="SELECT * FROM fstudata WHERE userID=? AND password=?";
    ...
    while(rs.next())
    {
        if (rs.getString(8).equals(uname) && rs.getString(9).equals(password1))
        {
